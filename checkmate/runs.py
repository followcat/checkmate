...
class TransitionTree(checkmate._tree.Tree):
    ...
    def __init__(self, transition, nodes=None):
        """
            ...
            >>> incoming_list = [checkmate._storage.InternalStorage(sample_app.data_structure.IActionRequest, 'AC()', None, sample_app.data_structure.ActionRequest, value='AC()')]
            >>> outgoing_list = [checkmate._storage.InternalStorage(sample_app.data_structure.IActionRequest, 'RE()', None, sample_app.data_structure.ActionRequest, value='RE()'), checkmate._storage.InternalStorage(sample_app.data_structure.IActionRequest, 'ARE()', None, sample_app.data_structure.ActionRequest, value='ARE()')]
